...
const Home = () => {
    ...
    environment to share data without revealing PII or compromising privacy.
                ...
                <div class="w-1/3 relative p-5 bg-gradient-to-r from-blue-400 to-blue-600 rounded-xl shadow-lg overflow-hidden mx-2 mt-4">
                ...
                <div class="w-1/3 relative p-5 bg-gradient-to-r from-blue-400 to-blue-600 rounded-xl shadow-lg overflow-hidden mx-2 mt-4">
                    <div class="relative z-10 mb-4 text-white text-8xl leading-none font-semibold">89</div>
                    <div class="relative z-10 text-blue-200 leading-none text-3xl font-semibold">Publishers</div>
                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="absolute right-0 bottom-0 h-32 w-32 -mr-8 -mb-8 text-blue-700 opacity-50">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                </div>
            ...
            <div className="flex flex-col text-coal w-full ">
                ...
                <div className="flex flex-wrap flex-row  items-stretch  w-full gap-y-3">
                    <div className="w-1/3 px-1">
                        <div class="relative flex flex-col items-start p-4 border border-neutral-100 bg-white shadow-lg rounded-lg bg-opacity-40 ">
            ...
            <div className="flex flex-col   w-2/5">
                ...
                <div className="flex justify-center">
                    <div className="rounded-lg shadow-lg bg-white max-w-sm w-full">
                        ...
                        <video width="320" height="100" controls className="w-full h-full rounded-lg">
