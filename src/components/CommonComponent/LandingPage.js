            ...
            <div className="flex items-center md:gap-x-12">
              ...
              >
                <img
                  ...
                  className=" flex flex-grow h-10 pl-0 pr-4   border-r-2 border-coal"
                />
                <img
                  src={GroupMLogo}
                  alt="Image_Description"
      ...
      <main>
        <div className="mx-auto max-w-7xl px-4 pb-16 pt-20 text-center sm:px-6 lg:px-8 lg:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
            Welcome to our innovative solution for secure data collaboration.
            With our state-of-the-art Cleanrooms, you can protect sensitive
            information while fostering efficient collaboration across teams,
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
              ...
              <p className="mt-6 text-lg tracking-tight text-blue-100">
                Seamlessly collaborate, share, and derive insights from vour
                data, revolutionizing the way you work with data.
              </p>
            </div>
              ...
              <div className="-mx-4 flex overflow-x-auto pb-4 sm:mx-0 sm:overflow-visible sm:pb-0 lg:col-span-5">
                ...
                >
                  <div className="group relative rounded-full bg-white px-4 py-1 lg:rounded-l-xl lg:rounded-r-none lg:bg-white/10 lg:p-6 lg:ring-1 lg:ring-inset lg:ring-white/10">
                    <h3>
                      <button
                        className="font-display [&amp;:not(:focus-visible)]:focus:outline-none text-lg text-blue-600 lg:text-white"
                      ...
                      >
                        ...
                        Low Code and No code UI{" "}
                      </button>
                    </h3>
                    <p className="mt-2 hidden text-sm text-white lg:block">
                      Low Code and No Code UI for Tailored User Experiences
                      eliminating the need of knowing technical details to use
                      data clean room.{" "}
                    </p>
                  </div>
                  <div className="group relative rounded-full px-4 py-1 hover:bg-white/10 lg:rounded-l-xl lg:rounded-r-none lg:p-6 lg:hover:bg-white/5">
                    <h3>
                      <button
                        className="font-display [&amp;:not(:focus-visible)]:focus:outline-none text-lg text-blue-100 hover:text-white lg:text-white"
                    ...
                    <p className="mt-2 hidden text-sm text-blue-100 group-hover:text-white lg:block">
                      Get started quickly and invite partners to securely
                      collaborate without much effort.{" "}
                    </p>
                  </div>
                  <div className="group relative rounded-full px-4 py-1 hover:bg-white/10 lg:rounded-l-xl lg:rounded-r-none lg:p-6 lg:hover:bg-white/5">
                    <h3>
                    ...
                    <p className="mt-2 hidden text-sm text-blue-100 group-hover:text-white lg:block">
                      Meet regulatory requirements and maintain compliance with
                      industry standards. Cleanrooms enable you to track and
                      monitor data interactions, providing an audit trail for
                  ...
                  <div className="group relative rounded-full px-4 py-1 hover:bg-white/10 lg:rounded-l-xl lg:rounded-r-none lg:p-6 lg:hover:bg-white/5">
                    ...
                    <p className="mt-2 hidden text-sm text-blue-100 group-hover:text-white lg:block">
                      DataHeaven serves as a dedicated workspace for
                      collaborative data analysis and exploration. Users can
                      collaborate within a controlled and secure environment.{" "}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="-mx-4 mt-20 flex flex-col gap-y-10 overflow-hidden px-4 sm:-mx-6 sm:px-6 lg:hidden">
              <div>
                <div className="mx-auto max-w-2xl">
                  ...
                  <p className="font-display mt-2 text-xl text-slate-900">
                    DataHeaven presents a powerful use case for Match Rate,
                    showcasing the capabilities of Snowflake Data Clean Room.
                    With Match Rate, you can efficiently match and merge data
                    from Provider’s date while maintaining a secure and
                    controlled environment.{" "}
                  </p>
                  <p className="mt-4 text-sm text-slate-600">
                    Match Rate, coupled with Snowflake Data Clean Room, empowers
                    organizations to achieve accurate and reliable data
                    matching. With our solution, you can streamline data
                    consolidation, enhance data quality, and drive valuable
                ...
                <div className="relative mt-10 pb-10">
                  ...
                  <div className="relative mx-auto w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                    <img
                      ...
                      src="https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fprofit-loss.2a2f85d5.png&amp;w=3840&amp;q=75"
                    />
                  </div>
                </div>
              </div>
              <div>
                <div className="mx-auto max-w-2xl">
                  ...
                  <p className="font-display mt-2 text-xl text-slate-900">
                    With our solution, you can enrich customer data, gain
                    valuable insights, and deliver personalized experiences
                    while ensuring the highest standards of data security and
                    privacy.{" "}
                  </p>
                  <p className="mt-4 text-sm text-slate-600">
                    Secure Data Collaboration, DataHeaven with Snowflake Data
                    Clean Room provides a controlled environment for
                    collaborating with internal and external stakeholders,
                    allowing you to securely access and share customer data for
                    enrichment purposes.{" "}
                  </p>
                </div>
                <div className="relative mt-10 pb-10">
                ...
                <div className="relative mt-10 pb-10">
                  ...
                  <div className="relative mx-auto w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                    <img
                      ...
                      src="https://salient.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcontacts.a61dce95.png&amp;w=3840&amp;q=75"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="hidden lg:mt-20 lg:block">
              ...
              >
                <div className="relative">
                  ...
                  <h3 className="mt-6 text-sm font-medium text-blue-600">
                    <button
                      ...
                      id="headlessui-tabs-tab-:Rirdm:"
                      role="tab"
                      type="button"
                      aria-selected="true"
                      tabIndex="0"
                      data-headlessui-state="selected"
                      aria-controls="headlessui-tabs-panel-:Rbbdm:"
                    >
                      <span className="absolute inset-0"></span>Match Rate
                    </button>
                  </h3>
                  <p className="font-display mt-2 text-xl text-slate-900">
                    DataHeaven presents a powerful use case for Match Rate.
                ...
                <div className="relative opacity-75 hover:opacity-100">
                  ...
                  <h3 className="mt-6 text-sm font-medium text-slate-600">
                    <button
                      className="[&amp;:not(:focus-visible)]:focus:outline-none"
                      id="headlessui-tabs-tab-:Rkrdm:"
                      role="tab"
                      type="button"
                      aria-selected="false"
                      tabIndex="-1"
                      data-headlessui-state=""
                      aria-controls="headlessui-tabs-panel-:Rjbdm:"
                    >
                      <span className="absolute inset-0"></span>Customer
                      Enrichment
                    </button>
                  </h3>
                  <p className="font-display mt-2 text-xl text-slate-900">
                ...
                <div className="relative opacity-75 hover:opacity-100">
                  ...
                  <h3 className="mt-6 text-sm font-medium text-slate-600">
                    <button
                      className="[&amp;:not(:focus-visible)]:focus:outline-none"
                      id="headlessui-tabs-tab-:Rmrdm:"
                      role="tab"
                      type="button"
                      aria-selected="false"
                      tabIndex="-1"
                      data-headlessui-state=""
                      aria-controls="headlessui-tabs-panel-:Rrbdm:"
                    >
                      <span className="absolute inset-0"></span>Secure Data
                      Collaboration
                    </button>
                  </h3>
                  <p className="font-display mt-2 text-xl text-slate-900">
              ...
              <div className="rounded-4xl relative mt-20 overflow-hidden bg-slate-200 px-14 py-16 xl:px-16">
                <div className="-mx-5 flex">
                  <div
                    className="[&amp;:not(:focus-visible)]:focus:outline-none px-5 transition duration-500 ease-in-out"
                    style={{ transform: "translateX(-0%)" }}
                    aria-hidden="false"
                    id="headlessui-tabs-panel-:Rbbdm:"
                    role="tabpanel"
                    tabIndex="0"
                    data-headlessui-state="selected"
                    aria-labelledby="headlessui-tabs-tab-:Rirdm:"
                  >
                  ...
                  <div
                    className="[&amp;:not(:focus-visible)]:focus:outline-none px-5 opacity-60 transition duration-500 ease-in-out"
                    style={{ transform: "translateX(-0%)" }}
                    aria-hidden="true"
                    id="headlessui-tabs-panel-:Rjbdm:"
                    role="tabpanel"
                    tabIndex="-1"
                    data-headlessui-state=""
                    aria-labelledby="headlessui-tabs-tab-:Rkrdm:"
                  >
                    <div className="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                      <img
                        alt=""
                  ...
                  <div
                    ...
                    style={{ transform: "translateX(-0%)" }}
                    aria-hidden="true"
                    id="headlessui-tabs-panel-:Rrbdm:"
                    role="tabpanel"
                    tabIndex="-1"
                    data-headlessui-state=""
                    aria-labelledby="headlessui-tabs-tab-:Rmrdm:"
                  >
                    <div className="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                      <img
                        alt=""
        ...
        >
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-lg text-center">
              ...
              <a
                className="group mt-10 inline-flex items-center justify-center rounded-full bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-blue-50 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:bg-blue-200 active:text-slate-600"
                href="/register"
              >
                Get started today
              </a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
            ...
            <p className="mt-6 text-sm text-slate-500 sm:mt-0">
              Copyright © 2023 Hoonar Tekwurks Private Ltd.
            </p>
          </div>
        </div>
      </footer>
