  ...
  return (
    <div className="  w-screen flex flex-col ">
      <div className=" sticky top-0 z-50 flex flex-row justify-between items-center bg-white drop-shadow-sm">
        <div className="h-16 px-6 flex justify-start items-center w-auto text-white bg-deep-navy focus:text-electric-green cursor-pointer"  onClick={() => setIsOpened(!isOpened)}>
        ...
        <div className=" ">
          ...
          <div className="mt-auto h-16 flex items-center w-full">
            <button 
              ...
              className= {`${(user?.name) ? "" : "invisible"} h-16 px-6 w-10 mx-auto flex  flex justify-center items-center
				w-full text-deep-navy  focus:outline-none`}>
              <svg
